...
insert  into `tblassign`(`assign_id`,`hotel_id`,`d_boy_id`,`booking_id`,`date_time`,`status`) values (1,2,1,1,'2022-10-04','pending'),(2,2,3,1,'2022-10-21','pending'),(3,2,3,1,'2022-10-21','pending'),(4,2,3,1,'2022-10-21','pending'),(5,2,3,1,'2022-10-21','pending');
...
insert  into `tbldelivery_boys`(`delivery_boy_id`,`hotel_id`,`login_id`,`first_name`,`last_name`,`house_name`,`place`,`phone`,`email`) values (1,2,11,'Sara','mary','kalarikkal','jhjghj','8987878787','marysara@gmail.com'),(3,2,12,'arun','hg','hfghf','ghjghj','8987878787','aleenatresa8@gmail.com');
...
insert  into `tbllogin`(`login_id`,`username`,`password`,`user_type`) values (1,'admin','admin123','admin'),(5,'ambily','1234','user'),(4,'Sagar','1234','entrepreneur'),(6,'Ammu','Ammu','user'),(12,'arun','arun','deliveryboy'),(11,'asas','asas','deliveryboy');
